...
public class MainActivity extends FragmentActivity implements View.OnClickListener, GoogleMap.OnMapClickListener, OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dConnected = myRef.child(idtoken).child("connected");
        dQueue = myRef.child(idtoken).child("queue");

        dQueue.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {

                droneCaptain(dataSnapshot);
    ...
    private void droneCaptain(DataSnapshot queue){
        String mode = queue.child("mode").getValue().toString();
